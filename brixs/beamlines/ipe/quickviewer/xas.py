#! /usr/bin/env python3
# -*- coding: utf-8 -*-
"""XAS quick viwer for IPE beamline
...
def update_plot():
    ...
    for i, item in enumerate(vars['selected']):
        ...
        for attr in TEY.get_attrs():
            if attr in ('PHASE', 'DVF', 'ENERGY_SP', 'SP_ENERGY', 'SP_PHASE', 'RING_CURRENT', 'TIMESTAMP'):
                pass
            else:
