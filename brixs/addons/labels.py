...
def rixs(title=None, grid=True, ax=None):
...
def energy_map(title=None, grid=True, ax=None):
...
def emission_map(title=None, grid=True, ax=None):
    """Quickly set x and y labels and title in energy map plots."""
    xlabel = 'Emission energy (eV)'
...
def th_map(title=None, grid=True, ax=None):
    """Quickly set x and y labels and title in energy map plots."""
    xlabel = r'$\Theta$ ($^\circ$)'
    ylabel = 'Energy loss (eV)'
    _xylabels(title=title, ax=ax, xlabel=xlabel, ylabel=ylabel, grid=grid)
...
def qmap_rlu(title=None, grid=True, ax=None):
