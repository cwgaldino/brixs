...
from brixs.model_functions import fwhmGauss


def simulate_spectrum(c, w, excitations):
    ...
    .. seealso:: :py:func:`simulate_photon_events`

    Example:
        Simulate a spectrum with two excitations with half the area of the
        elastic peak and twice its fwhm.

        >>> from brixs.simulate import simulate_spectrum
        >>> import matplotlib.pyplot as plt
        >>> import numpy as np
        >>> I = simulate_spectrum(0, 0.2, excitations=[[0.5, 2, 2], [0.5, 4, 2]])
...
def simulate_photon_events(I, background=0,
                              noise=0,
                              exposure=100e4,
    ...
    .. seealso:: :py:func:`simulate_spectrum`
