...
Tv_4p_4d = CalculateT(ev)
Th_4p_4d = CalculateT(eh)
Tr_4p_4d = CalculateT(er)
Tl_4p_4d = CalculateT(el)
Tk_4p_4d = CalculateT(k)
...
if ValueInTable(spectrum, spectra) then
    ...
    for j, operator in ipairs({Tr_4p_4d, Tl_4p_4d, Tk_4p_4d}) do
...
if ValueInTable(spectrum, spectra) then
    ...
    if ValueInTable('Isotropic', spectra) then
        table.insert(indices_4p_4d[spectrum], 1)
        table.insert(indices_4p_4d[spectrum], 2)
    else
