...
if H_atomic == 1 then
    ...
    G2_4s_4d_f = $G2(4s,4d)_f_value * $G2(4s,4d)_f_scale
...
if H_4d_ligands_hybridization_lmct == 1 then
    ...
    e_L1_f = ((1 + NElectrons_4d) * (NElectrons_4d * U_4d_4d_f / 2 + 2 * U_4s_4d_f) - (2 + NElectrons_4d) * Delta_4d_L1_f) / (12 + NElectrons_4d)
...
if H_4d_ligands_hybridization_mlct == 1 then
    ...
    e_L2_f = (2 * Delta_4d_L2_f * NElectrons_4d + 4 * Delta_4d_L2_f - U_4d_4d_f * NElectrons_4d^2 - U_4d_4d_f * NElectrons_4d - 4 * U_4s_4d_f * NElectrons_4d - 4 * U_4s_4d_f) / (2  *(NElectrons_4d + 2))
...
function CalculateT(e, k)
    ...
    T = (e[1] * k[2] + e[2] * k[1]) * Txy_4s_4d
      + (e[1] * k[3] + e[3] * k[1]) * Txz_4s_4d
      + (e[2] * k[3] + e[3] * k[2]) * Tyz_4s_4d
      + (e[1] * k[1] + e[2] * k[2]) * Tx2y2_4s_4d
      + e[3] * k[3] * Tz2_4s_4d
    return Chop(T)
end

Tv_4s_4d = CalculateT(ev, k)
Th_4s_4d = CalculateT(eh, k)
Tr_4s_4d = CalculateT(er, k)
Tl_4s_4d = CalculateT(el, k)
Tk_4s_4d = CalculateT(k, k)
...
if ValueInTable(spectrum, spectra) then
    indices_4s_4d[spectrum] = {}
    for j, operator in ipairs({Txy_4s_4d, Txz_4s_4d, Tyz_4s_4d, Tx2y2_4s_4d, Tz2_4s_4d}) do
        table.insert(T_4s_4d, operator)
        table.insert(indices_4s_4d[spectrum], c)
        c = c + 1
    end
end
...
if ValueInTable(spectrum, spectra) then
    indices_4s_4d[spectrum] = {}
    for j, operator in ipairs({Tr_4s_4d, Tl_4s_4d}) do
        table.insert(T_4s_4d, operator)
        table.insert(indices_4s_4d[spectrum], c)
        c = c + 1
    end
...
if ValueInTable(spectrum, spectra) then
    indices_4s_4d[spectrum] = {}
    for j, operator in ipairs({Tv_4s_4d, Th_4s_4d}) do
        table.insert(T_4s_4d, operator)
        table.insert(indices_4s_4d[spectrum], c)
        c = c + 1
    end
...
if CalculationRestrictions == nil then
    G_4s_4d = CreateSpectra(H_f, T_4s_4d, Psis_i, {{'Emin', Emin}, {'Emax', Emax}, {'NE', NE}, {'Gamma', Gamma}, {'DenseBorder', DenseBorder}})
else
    G_4s_4d = CreateSpectra(H_f, T_4s_4d, Psis_i, {{'Emin', Emin}, {'Emax', Emax}, {'NE', NE}, {'Gamma', Gamma}, {'restrictions', CalculationRestrictions}, {'DenseBorder', DenseBorder}})
end

-- Create a list with the Boltzmann probabilities for a given operator
-- and state.
dZ_4s_4d = {}
for i in ipairs(T_4s_4d) do
    for j in ipairs(Psis_i) do
        table.insert(dZ_4s_4d, dZ[j])
    end
end
...
spectrum = 'Isotropic'
if ValueInTable(spectrum, spectra) then
    Giso = GetSpectrum(G_4s_4d, T_4s_4d, Psis_i, indices_4s_4d[spectrum], dZ_4s_4d)
    Giso = Giso / 15 / Pcl_4s_4d
    SaveSpectrum(Giso, 'iso')
end

spectrum = 'Circular Dichroism'
if ValueInTable(spectrum, spectra) then
    Gr = GetSpectrum(G_4s_4d, T_4s_4d, Psis_i, indices_4s_4d[spectrum][1], dZ_4s_4d)
    Gl = GetSpectrum(G_4s_4d, T_4s_4d, Psis_i, indices_4s_4d[spectrum][2], dZ_4s_4d)
    Gr = Gr / Pcl_4s_4d
    Gl = Gl / Pcl_4s_4d
    SaveSpectrum(Gr, 'r')
    SaveSpectrum(Gl, 'l')
...
spectrum = 'Linear Dichroism'
if ValueInTable(spectrum, spectra) then
    Gv = GetSpectrum(G_4s_4d, T_4s_4d, Psis_i, indices_4s_4d[spectrum][1], dZ_4s_4d)
    Gh = GetSpectrum(G_4s_4d, T_4s_4d, Psis_i, indices_4s_4d[spectrum][2], dZ_4s_4d)
    Gv = Gv / Pcl_4s_4d
    Gh = Gh / Pcl_4s_4d
    SaveSpectrum(Gv, 'v')
    SaveSpectrum(Gh, 'h')
