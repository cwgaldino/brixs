...
if H_atomic == 1 then
    ...
    G2_2s_5d_f = $G2(2s,5d)_f_value * $G2(2s,5d)_f_scale
...
if H_5d_ligands_hybridization_lmct == 1 then
    ...
    e_L1_f = ((1 + NElectrons_5d) * (NElectrons_5d * U_5d_5d_f / 2 + 2 * U_2s_5d_f) - (2 + NElectrons_5d) * Delta_5d_L1_f) / (12 + NElectrons_5d)
...
if H_5d_ligands_hybridization_mlct == 1 then
    ...
    e_L2_f = (2 * Delta_5d_L2_f * NElectrons_5d + 4 * Delta_5d_L2_f - U_5d_5d_f * NElectrons_5d^2 - U_5d_5d_f * NElectrons_5d - 4 * U_2s_5d_f * NElectrons_5d - 4 * U_2s_5d_f) / (2  *(NElectrons_5d + 2))
...
function CalculateT(e, k)
    ...
    T = (e[1] * k[2] + e[2] * k[1]) * Txy_2s_5d
      + (e[1] * k[3] + e[3] * k[1]) * Txz_2s_5d
      + (e[2] * k[3] + e[3] * k[2]) * Tyz_2s_5d
      + (e[1] * k[1] + e[2] * k[2]) * Tx2y2_2s_5d
      + e[3] * k[3] * Tz2_2s_5d
    return Chop(T)
end

Tv_2s_5d = CalculateT(ev, k)
Th_2s_5d = CalculateT(eh, k)
Tr_2s_5d = CalculateT(er, k)
Tl_2s_5d = CalculateT(el, k)
Tk_2s_5d = CalculateT(k, k)
...
if ValueInTable(spectrum, spectra) then
    ...
    for j, operator in ipairs({Txy_2s_5d, Txz_2s_5d, Tyz_2s_5d, Tx2y2_2s_5d, Tz2_2s_5d}) do
...
if ValueInTable(spectrum, spectra) then
    indices_2s_5d[spectrum] = {}
    for j, operator in ipairs({Tv_2s_5d, Th_2s_5d}) do
        table.insert(T_2s_5d, operator)
        table.insert(indices_2s_5d[spectrum], c)
        c = c + 1
    end
...
if CalculationRestrictions == nil then
    G_2s_5d = CreateSpectra(H_f, T_2s_5d, Psis_i, {{'Emin', Emin}, {'Emax', Emax}, {'NE', NE}, {'Gamma', Gamma}, {'DenseBorder', DenseBorder}})
else
    G_2s_5d = CreateSpectra(H_f, T_2s_5d, Psis_i, {{'Emin', Emin}, {'Emax', Emax}, {'NE', NE}, {'Gamma', Gamma}, {'restrictions', CalculationRestrictions}, {'DenseBorder', DenseBorder}})
end

-- Create a list with the Boltzmann probabilities for a given operator
-- and state.
dZ_2s_5d = {}
for i in ipairs(T_2s_5d) do
    for j in ipairs(Psis_i) do
        table.insert(dZ_2s_5d, dZ[j])
    end
end
