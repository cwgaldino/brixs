...
IndexDn_5d = {0, 2, 4, 6, 8}
IndexUp_5d = {1, 3, 5, 7, 9}
...
if H_atomic == 1 then
    ...
    F0_5d_5f = NewOperator('U', NFermions, IndexUp_5d, IndexDn_5d, IndexUp_5f, IndexDn_5f, {1, 0, 0}, {0, 0, 0});
    F2_5d_5f = NewOperator('U', NFermions, IndexUp_5d, IndexDn_5d, IndexUp_5f, IndexDn_5f, {0, 1, 0}, {0, 0, 0});
    F4_5d_5f = NewOperator('U', NFermions, IndexUp_5d, IndexDn_5d, IndexUp_5f, IndexDn_5f, {0, 0, 1}, {0, 0, 0});
    G1_5d_5f = NewOperator('U', NFermions, IndexUp_5d, IndexDn_5d, IndexUp_5f, IndexDn_5f, {0, 0, 0}, {1, 0, 0});
    G3_5d_5f = NewOperator('U', NFermions, IndexUp_5d, IndexDn_5d, IndexUp_5f, IndexDn_5f, {0, 0, 0}, {0, 1, 0});
    G5_5d_5f = NewOperator('U', NFermions, IndexUp_5d, IndexDn_5d, IndexUp_5f, IndexDn_5f, {0, 0, 0}, {0, 0, 1});
    ...
    U_5d_5f_f = $U(5d,5f)_f_value
    F2_5d_5f_f = $F2(5d,5f)_f_value * $F2(5d,5f)_f_scale
    F4_5d_5f_f = $F4(5d,5f)_f_value * $F4(5d,5f)_f_scale
    G1_5d_5f_f = $G1(5d,5f)_f_value * $G1(5d,5f)_f_scale
    G3_5d_5f_f = $G3(5d,5f)_f_value * $G3(5d,5f)_f_scale
    G5_5d_5f_f = $G5(5d,5f)_f_value * $G5(5d,5f)_f_scale
    F0_5d_5f_f = U_5d_5f_f + 3 / 70 * G1_5d_5f_f + 2 / 105 * G3_5d_5f_f + 5 / 231 * G5_5d_5f_f
...
--------------------------------------------------------------------------------
InitialRestrictions = {NFermions, NBosons, {'1111111111 00000000000000', NElectrons_5d, NElectrons_5d},
                                           {'0000000000 11111111111111', NElectrons_5f, NElectrons_5f}}

FinalRestrictions = {NFermions, NBosons, {'1111111111 00000000000000', NElectrons_5d - 1, NElectrons_5d - 1},
                                         {'0000000000 11111111111111', NElectrons_5f + 1, NElectrons_5f + 1}}

Operators = {H_i, Ssqr, Lsqr, Jsqr, Sz, Lz, Jz, Tz, ldots_5d, N_5d, N_5f, 'dZ'}
header = 'Analysis of the initial Hamiltonian:\n'
header = header .. '=================================================================================================================================\n'
header = header .. 'State         <E>     <S^2>     <L^2>     <J^2>      <Sz>      <Lz>      <Jz>      <Tz>     <l.s>    <N_5d>    <N_5f>          dZ\n'
header = header .. '=================================================================================================================================\n'
footer = '=================================================================================================================================\n'
...
Tx_5d_5f = NewOperator('CF', NFermions, IndexUp_5f, IndexDn_5f, IndexUp_5d, IndexDn_5d, {{1, -1, t    }, {1, 1, -t    }})
Ty_5d_5f = NewOperator('CF', NFermions, IndexUp_5f, IndexDn_5f, IndexUp_5d, IndexDn_5d, {{1, -1, t * I}, {1, 1,  t * I}})
Tz_5d_5f = NewOperator('CF', NFermions, IndexUp_5f, IndexDn_5f, IndexUp_5d, IndexDn_5d, {{1,  0, 1    }                })
...
function CalculateT(e)
    ...
    T = e[1] * Tx_5d_5f + e[2] * Ty_5d_5f + e[3] * Tz_5d_5f
    return Chop(T)
end

Tv_5d_5f = CalculateT(ev, k)
Th_5d_5f = CalculateT(eh, k)
Tr_5d_5f = CalculateT(er, k)
Tl_5d_5f = CalculateT(el, k)
Tk_5d_5f = CalculateT(k, k)
...
if ValueInTable(spectrum, spectra) then
    indices_5d_5f[spectrum] = {}
    for j, operator in ipairs({Tr_5d_5f, Tl_5d_5f, Tk_5d_5f}) do
        table.insert(T_5d_5f, operator)
        table.insert(indices_5d_5f[spectrum], c)
        c = c + 1
    end
end
...
if ValueInTable(spectrum, spectra) then
    ...
    if ValueInTable('Isotropic', table) then
        for j, operator in ipairs({Tr_5d_5f, Tl_5d_5f}) do
            table.insert(T_5d_5f, operator)
            table.insert(indices_5d_5f[spectrum], c)
            c = c + 1
        end
    else
        table.insert(indices_5d_5f[spectrum], 1)
        table.insert(indices_5d_5f[spectrum], 2)
    end
end
...
if ValueInTable(spectrum, spectra) then
    indices_5d_5f[spectrum] = {}
    for j, operator in ipairs({Tv_5d_5f, Th_5d_5f}) do
        table.insert(T_5d_5f, operator)
        table.insert(indices_5d_5f[spectrum], c)
        c = c + 1
    end
...
if CalculationRestrictions == nil then
    G_5d_5f = CreateSpectra(H_f, T_5d_5f, Psis_i, {{'Emin', Emin}, {'Emax', Emax}, {'NE', NE}, {'Gamma', Gamma}, {'DenseBorder', DenseBorder}})
else
    G_5d_5f = CreateSpectra(H_f, T_5d_5f, Psis_i, {{'Emin', Emin}, {'Emax', Emax}, {'NE', NE}, {'Gamma', Gamma}, {'restrictions', CalculationRestrictions}, {'DenseBorder', DenseBorder}})
end

-- Create a list with the Boltzmann probabilities for a given operator
-- and state.
dZ_5d_5f = {}
for i in ipairs(T_5d_5f) do
    for j in ipairs(Psis_i) do
        table.insert(dZ_5d_5f, dZ[j])
    end
end

spectrum = 'Isotropic'
if ValueInTable(spectrum, spectra) then
        Giso = GetSpectrum(G_5d_5f, T_5d_5f, Psis_i, indices_5d_5f[spectrum], dZ_5d_5f)
        Giso = Giso / 3
...
spectrum = 'Circular Dichroism'
if ValueInTable(spectrum, spectra) then
        Gr = GetSpectrum(G_5d_5f, T_5d_5f, Psis_i, indices_5d_5f[spectrum][1], dZ_5d_5f)
        Gl = GetSpectrum(G_5d_5f, T_5d_5f, Psis_i, indices_5d_5f[spectrum][2], dZ_5d_5f)
        SaveSpectrum(Gr, 'r')
        SaveSpectrum(Gl, 'l')
...
spectrum = 'Linear Dichroism'
if ValueInTable(spectrum, spectra) then
        Gv = GetSpectrum(G_5d_5f, T_5d_5f, Psis_i, indices_5d_5f[spectrum][1], dZ_5d_5f)
        Gh = GetSpectrum(G_5d_5f, T_5d_5f, Psis_i, indices_5d_5f[spectrum][2], dZ_5d_5f)
        SaveSpectrum(Gv, 'v')
        SaveSpectrum(Gh, 'h')
