...
if H_4d_ligands_hybridization_mlct == 1 then
    ...
    e_L2_f = (2 * Delta_4d_L2_f * NElectrons_4d + 12 * Delta_4d_L2_f - U_4d_4d_f * NElectrons_4d^2 - U_4d_4d_f * NElectrons_4d - 12 * U_2p_4d_f * NElectrons_4d - 12 * U_2p_4d_f) / (2 * (NElectrons_4d + 6))
...
Tv_2p_4d = CalculateT(ev)
Th_2p_4d = CalculateT(eh)
Tr_2p_4d = CalculateT(er)
Tl_2p_4d = CalculateT(el)
Tk_2p_4d = CalculateT(k)
...
if ValueInTable(spectrum, spectra) then
    indices_2p_4d[spectrum] = {}
    for j, operator in ipairs({Tr_2p_4d, Tl_2p_4d, Tk_2p_4d}) do
        table.insert(T_2p_4d, operator)
        table.insert(indices_2p_4d[spectrum], c)
        c = c + 1
    end
end
...
if ValueInTable(spectrum, spectra) then
    ...
    if ValueInTable('Isotropic', spectra) then
        table.insert(indices_2p_4d[spectrum], 1)
        table.insert(indices_2p_4d[spectrum], 2)
    else
        for j, operator in ipairs({Tr_2p_4d, Tl_2p_4d}) do
            table.insert(T_2p_4d, operator)
            table.insert(indices_2p_4d[spectrum], c)
            c = c + 1
        end
...
if ValueInTable(spectrum, spectra) then
    indices_2p_4d[spectrum] = {}
    for j, operator in ipairs({Tv_2p_4d, Th_2p_4d}) do
        table.insert(T_2p_4d, operator)
        table.insert(indices_2p_4d[spectrum], c)
        c = c + 1
    end
...
if CalculationRestrictions == nil then
    G_2p_4d = CreateSpectra(H_f, T_2p_4d, Psis_i, {{'Emin', Emin}, {'Emax', Emax}, {'NE', NE}, {'Gamma', Gamma}, {'DenseBorder', DenseBorder}})
else
    G_2p_4d = CreateSpectra(H_f, T_2p_4d, Psis_i, {{'Emin', Emin}, {'Emax', Emax}, {'NE', NE}, {'Gamma', Gamma}, {'restrictions', CalculationRestrictions}, {'DenseBorder', DenseBorder}})
end
...
spectrum = 'Isotropic'
if ValueInTable(spectrum, spectra) then
    Giso = GetSpectrum(G_2p_4d, T_2p_4d, Psis_i, indices_2p_4d[spectrum], dZ_2p_4d)
    Giso = Giso / 3 / Pcl_2p_4d
    SaveSpectrum(Giso, 'iso')
end

spectrum = 'Circular Dichroism'
if ValueInTable(spectrum, spectra) then
    Gr = GetSpectrum(G_2p_4d, T_2p_4d, Psis_i, indices_2p_4d[spectrum][1], dZ_2p_4d)
    Gl = GetSpectrum(G_2p_4d, T_2p_4d, Psis_i, indices_2p_4d[spectrum][2], dZ_2p_4d)
    Gr = Gr / Pcl_2p_4d
    Gl = Gl / Pcl_2p_4d
    SaveSpectrum(Gr, 'r')
    SaveSpectrum(Gl, 'l')
...
spectrum = 'Linear Dichroism'
if ValueInTable(spectrum, spectra) then
    Gv = GetSpectrum(G_2p_4d, T_2p_4d, Psis_i, indices_2p_4d[spectrum][1], dZ_2p_4d)
    Gh = GetSpectrum(G_2p_4d, T_2p_4d, Psis_i, indices_2p_4d[spectrum][2], dZ_2p_4d)
    Gv = Gv / Pcl_2p_4d
    Gh = Gh / Pcl_2p_4d
    SaveSpectrum(Gv, 'v')
    SaveSpectrum(Gh, 'h')
