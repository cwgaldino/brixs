...
function CalculateT(e, k)
    ...
    T = (e[1] * k[2] + e[2] * k[1]) * Txy_5s_5d
      + (e[1] * k[3] + e[3] * k[1]) * Txz_5s_5d
      + (e[2] * k[3] + e[3] * k[2]) * Tyz_5s_5d
      + (e[1] * k[1] + e[2] * k[2]) * Tx2y2_5s_5d
      + e[3] * k[3] * Tz2_5s_5d
    return Chop(T)
end

Tv_5s_5d = CalculateT(ev, k)
Th_5s_5d = CalculateT(eh, k)
Tr_5s_5d = CalculateT(er, k)
Tl_5s_5d = CalculateT(el, k)
Tk_5s_5d = CalculateT(k, k)
...
if ValueInTable(spectrum, spectra) then
    indices_5s_5d[spectrum] = {}
    for j, operator in ipairs({Txy_5s_5d, Txz_5s_5d, Tyz_5s_5d, Tx2y2_5s_5d, Tz2_5s_5d}) do
        table.insert(T_5s_5d, operator)
        table.insert(indices_5s_5d[spectrum], c)
        c = c + 1
    end
end
...
if ValueInTable(spectrum, spectra) then
    indices_5s_5d[spectrum] = {}
    for j, operator in ipairs({Tr_5s_5d, Tl_5s_5d}) do
        table.insert(T_5s_5d, operator)
        table.insert(indices_5s_5d[spectrum], c)
        c = c + 1
    end
...
if ValueInTable(spectrum, spectra) then
    indices_5s_5d[spectrum] = {}
    for j, operator in ipairs({Tv_5s_5d, Th_5s_5d}) do
        table.insert(T_5s_5d, operator)
        table.insert(indices_5s_5d[spectrum], c)
        c = c + 1
    end
...
if CalculationRestrictions == nil then
    G_5s_5d = CreateSpectra(H_f, T_5s_5d, Psis_i, {{'Emin', Emin}, {'Emax', Emax}, {'NE', NE}, {'Gamma', Gamma}, {'DenseBorder', DenseBorder}})
else
    G_5s_5d = CreateSpectra(H_f, T_5s_5d, Psis_i, {{'Emin', Emin}, {'Emax', Emax}, {'NE', NE}, {'Gamma', Gamma}, {'restrictions', CalculationRestrictions}, {'DenseBorder', DenseBorder}})
end

-- Create a list with the Boltzmann probabilities for a given operator
-- and state.
dZ_5s_5d = {}
for i in ipairs(T_5s_5d) do
    for j in ipairs(Psis_i) do
        table.insert(dZ_5s_5d, dZ[j])
    end
end
...
spectrum = 'Isotropic'
if ValueInTable(spectrum, spectra) then
    Giso = GetSpectrum(G_5s_5d, T_5s_5d, Psis_i, indices_5s_5d[spectrum], dZ_5s_5d)
    Giso = Giso / 15 / Pcl_5s_5d
    SaveSpectrum(Giso, 'iso')
end

spectrum = 'Circular Dichroism'
if ValueInTable(spectrum, spectra) then
    Gr = GetSpectrum(G_5s_5d, T_5s_5d, Psis_i, indices_5s_5d[spectrum][1], dZ_5s_5d)
    Gl = GetSpectrum(G_5s_5d, T_5s_5d, Psis_i, indices_5s_5d[spectrum][2], dZ_5s_5d)
    Gr = Gr / Pcl_5s_5d
    Gl = Gl / Pcl_5s_5d
    SaveSpectrum(Gr, 'r')
    SaveSpectrum(Gl, 'l')
...
spectrum = 'Linear Dichroism'
if ValueInTable(spectrum, spectra) then
    Gv = GetSpectrum(G_5s_5d, T_5s_5d, Psis_i, indices_5s_5d[spectrum][1], dZ_5s_5d)
    Gh = GetSpectrum(G_5s_5d, T_5s_5d, Psis_i, indices_5s_5d[spectrum][2], dZ_5s_5d)
    Gv = Gv / Pcl_5s_5d
    Gh = Gh / Pcl_5s_5d
    SaveSpectrum(Gv, 'v')
    SaveSpectrum(Gh, 'h')
