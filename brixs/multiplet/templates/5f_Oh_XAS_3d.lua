...
if H_atomic == 1 then
    ...
    F2_3d_5f_f = $F2(3d,5f)_f_value * $F2(3d,5f)_f_scale
    F4_3d_5f_f = $F4(3d,5f)_f_value * $F4(3d,5f)_f_scale
    G1_3d_5f_f = $G1(3d,5f)_f_value * $G1(3d,5f)_f_scale
    G3_3d_5f_f = $G3(3d,5f)_f_value * $G3(3d,5f)_f_scale
    G5_3d_5f_f = $G5(3d,5f)_f_value * $G5(3d,5f)_f_scale
...
function CalculateT(e)
    ...
    T = e[1] * Tx_3d_5f + e[2] * Ty_3d_5f + e[3] * Tz_3d_5f
    return Chop(T)
end

Tv_3d_5f = CalculateT(ev)
Th_3d_5f = CalculateT(eh)
Tr_3d_5f = CalculateT(er)
Tl_3d_5f = CalculateT(el)
Tk_3d_5f = CalculateT(k)
...
if ValueInTable(spectrum, spectra) then
    indices_3d_5f[spectrum] = {}
    for j, operator in ipairs({Tr_3d_5f, Tl_3d_5f, Tk_3d_5f}) do
        table.insert(T_3d_5f, operator)
        table.insert(indices_3d_5f[spectrum], c)
        c = c + 1
    end
end
...
if ValueInTable(spectrum, spectra) then
    ...
    if ValueInTable('Isotropic', spectra) then
        table.insert(indices_3d_5f[spectrum], 1)
        table.insert(indices_3d_5f[spectrum], 2)
    else
        for j, operator in ipairs({Tr_3d_5f, Tl_3d_5f}) do
            table.insert(T_3d_5f, operator)
            table.insert(indices_3d_5f[spectrum], c)
            c = c + 1
        end
...
if ValueInTable(spectrum, spectra) then
    indices_3d_5f[spectrum] = {}
    for j, operator in ipairs({Tv_3d_5f, Th_3d_5f}) do
        table.insert(T_3d_5f, operator)
        table.insert(indices_3d_5f[spectrum], c)
        c = c + 1
    end
...
if CalculationRestrictions == nil then
    G_3d_5f = CreateSpectra(H_f, T_3d_5f, Psis_i, {{'Emin', Emin}, {'Emax', Emax}, {'NE', NE}, {'Gamma', Gamma}, {'DenseBorder', DenseBorder}})
else
    G_3d_5f = CreateSpectra(H_f, T_3d_5f, Psis_i, {{'Emin', Emin}, {'Emax', Emax}, {'NE', NE}, {'Gamma', Gamma}, {'restrictions', CalculationRestrictions}, {'DenseBorder', DenseBorder}})
end
...
spectrum = 'Isotropic'
if ValueInTable(spectrum, spectra) then
    Giso = GetSpectrum(G_3d_5f, T_3d_5f, Psis_i, indices_3d_5f[spectrum], dZ_3d_5f)
    Giso = Giso / 3 / Pcl_3d_5f
    SaveSpectrum(Giso, 'iso')
end

spectrum = 'Circular Dichroism'
if ValueInTable(spectrum, spectra) then
    Gr = GetSpectrum(G_3d_5f, T_3d_5f, Psis_i, indices_3d_5f[spectrum][1], dZ_3d_5f)
    Gl = GetSpectrum(G_3d_5f, T_3d_5f, Psis_i, indices_3d_5f[spectrum][2], dZ_3d_5f)
    Gr = Gr / Pcl_3d_5f
    Gl = Gl / Pcl_3d_5f
    SaveSpectrum(Gr, 'r')
    SaveSpectrum(Gl, 'l')
...
spectrum = 'Linear Dichroism'
if ValueInTable(spectrum, spectra) then
    Gv = GetSpectrum(G_3d_5f, T_3d_5f, Psis_i, indices_3d_5f[spectrum][1], dZ_3d_5f)
    Gh = GetSpectrum(G_3d_5f, T_3d_5f, Psis_i, indices_3d_5f[spectrum][2], dZ_3d_5f)
    Gv = Gv / Pcl_3d_5f
    Gh = Gh / Pcl_3d_5f
    SaveSpectrum(Gv, 'v')
    SaveSpectrum(Gh, 'h')
