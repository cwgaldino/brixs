...
if H_5d_ligands_hybridization_mlct == 1 then
    ...
    e_L2_f = (2 * Delta_5d_L2_f * NElectrons_5d + 12 * Delta_5d_L2_f - U_5d_5d_f * NElectrons_5d^2 - U_5d_5d_f * NElectrons_5d - 12 * U_2p_5d_f * NElectrons_5d - 12 * U_2p_5d_f) / (2 * (NElectrons_5d + 6))
...
if ValueInTable(spectrum, spectra) then
    indices_2p_5d[spectrum] = {}
    for j, operator in ipairs({Tr_2p_5d, Tl_2p_5d, Tk_2p_5d}) do
        table.insert(T_2p_5d, operator)
        table.insert(indices_2p_5d[spectrum], c)
        c = c + 1
    end
end
...
if ValueInTable(spectrum, spectra) then
    ...
    if ValueInTable('Isotropic', spectra) then
        table.insert(indices_2p_5d[spectrum], 1)
        table.insert(indices_2p_5d[spectrum], 2)
    else
        for j, operator in ipairs({Tr_2p_5d, Tl_2p_5d}) do
            table.insert(T_2p_5d, operator)
            table.insert(indices_2p_5d[spectrum], c)
            c = c + 1
        end
...
if ValueInTable(spectrum, spectra) then
    indices_2p_5d[spectrum] = {}
    for j, operator in ipairs({Tv_2p_5d, Th_2p_5d}) do
        table.insert(T_2p_5d, operator)
        table.insert(indices_2p_5d[spectrum], c)
        c = c + 1
    end
...
if CalculationRestrictions == nil then
    G_2p_5d = CreateSpectra(H_f, T_2p_5d, Psis_i, {{'Emin', Emin}, {'Emax', Emax}, {'NE', NE}, {'Gamma', Gamma}, {'DenseBorder', DenseBorder}})
else
    G_2p_5d = CreateSpectra(H_f, T_2p_5d, Psis_i, {{'Emin', Emin}, {'Emax', Emax}, {'NE', NE}, {'Gamma', Gamma}, {'restrictions', CalculationRestrictions}, {'DenseBorder', DenseBorder}})
end
...
spectrum = 'Isotropic'
if ValueInTable(spectrum, spectra) then
    Giso = GetSpectrum(G_2p_5d, T_2p_5d, Psis_i, indices_2p_5d[spectrum], dZ_2p_5d)
    Giso = Giso / 3 / Pcl_2p_5d
    SaveSpectrum(Giso, 'iso')
end

spectrum = 'Circular Dichroism'
if ValueInTable(spectrum, spectra) then
    Gr = GetSpectrum(G_2p_5d, T_2p_5d, Psis_i, indices_2p_5d[spectrum][1], dZ_2p_5d)
    Gl = GetSpectrum(G_2p_5d, T_2p_5d, Psis_i, indices_2p_5d[spectrum][2], dZ_2p_5d)
    Gr = Gr / Pcl_2p_5d
    Gl = Gl / Pcl_2p_5d
    SaveSpectrum(Gr, 'r')
    SaveSpectrum(Gl, 'l')
...
spectrum = 'Linear Dichroism'
if ValueInTable(spectrum, spectra) then
    Gv = GetSpectrum(G_2p_5d, T_2p_5d, Psis_i, indices_2p_5d[spectrum][1], dZ_2p_5d)
    Gh = GetSpectrum(G_2p_5d, T_2p_5d, Psis_i, indices_2p_5d[spectrum][2], dZ_2p_5d)
    Gv = Gv / Pcl_2p_5d
    Gh = Gh / Pcl_2p_5d
    SaveSpectrum(Gv, 'v')
    SaveSpectrum(Gh, 'h')
