...
function CalculateT_2p_3d(e)
    -- Calculate the transition operator for arbitrary polarization.
    T = e[1] * Tx_2p_3d + e[2] * Ty_2p_3d + e[3] * Tz_2p_3d
    return Chop(T)
end

function CalculateT_3d_2p(e)
    -- Calculate the transition operator for arbitrary polarization.
    T = e[1] * Tx_3d_2p + e[2] * Ty_3d_2p + e[3] * Tz_3d_2p
    return Chop(T)
end

Tv_2p_3d = CalculateT_2p_3d(ev1)
Th_2p_3d = CalculateT_2p_3d(eh1)
Tr_2p_3d = CalculateT_2p_3d(er1)
Tl_2p_3d = CalculateT_2p_3d(el1)
Tk_2p_3d = CalculateT_2p_3d(k1)

Tv_3d_2p = CalculateT_3d_2p(ev2)
Th_3d_2p = CalculateT_3d_2p(eh2)
Tr_3d_2p = CalculateT_3d_2p(er2)
Tl_3d_2p = CalculateT_3d_2p(el2)
Tk_3d_2p = CalculateT_3d_2p(k2)
...
--------------------------------------------------------------------------------
-- Print all final-state excitations contributing to RIXS
--------------------------------------------------------------------------------

if CalculationRestrictions == nil then
    Psis_f = Eigensystem(H_f, FinalRestrictions, 120) -- choose enough states
else
    Psis_f = Eigensystem(H_f, FinalRestrictions, 120,
                         {{'restrictions', CalculationRestrictions}})
end

if not (type(Psis_f) == 'table') then
    Psis_f = {Psis_f}
end

-- operators for identifying states
Ops = {Ssqr, Lsqr, Jsqr, ldots_3d, N_3d}

file = io.open("rixs_excitations.dat","w")

file:write(
"# i f Ei Ef Eloss weight <S2> <L2> <J2> <L.S> <N3d>\n"
)

for i, Psi_i in ipairs(Psis_i) do

    Ei =  Psi_i * H_i * Psi_i

    for f, Psi_f in ipairs(Psis_f) do

        Ef = Psi_f * H_f * Psi_f

        -- energy loss (positive for excited final states)
        Eloss = Ef - Ei

        S2  = Complex.Re(Psi_f * Ssqr     * Psi_f)
        L2  = Complex.Re(Psi_f * Lsqr     * Psi_f)
        J2  = Complex.Re(Psi_f * Jsqr     * Psi_f)
        LS  = Complex.Re(Psi_f * ldots_3d * Psi_f)
        N3d = Complex.Re(Psi_f * N_3d     * Psi_f)

        file:write(string.format(
            "%4d %4d %12.6f %12.6f %12.6f %12.6e %10.4f %10.4f %10.4f %10.4f %10.4f\n",
            i,
            f,
            Ei,
            Ef,
...
file = io.open("rixs_allowed_transitions.dat","w")
file:write("# i f Eloss Intensity\n")

for i,Psi_i in ipairs(Psis_i) do
    Ei = Complex.Re(Psi_i * H_i * Psi_i)

    Vin = Ain * Psi_i

    for f,Psi_f in ipairs(Psis_f) do
        Ef = Complex.Re(Psi_f * H_f * Psi_f)

        -- simplified direct overlap
        amp = Psi_f * Aout * Vin

        I = math.abs(Complex.Re(amp))^2 + math.abs(Complex.Im(amp))^2
...
if ValueInTable(spectrum, spectra) then
    if CalculationRestrictions == nil then
        Grv_ = G + CreateResonantSpectra(H_m, H_f, Tr_2p_3d, Tv_3d_2p, Psis_i, {{'Emin1', Emin1}, {'Emax1', Emax1}, {'NE1', NE1}, {'Gamma1', Gamma1}, {'Emin2', Emin2}, {'Emax2', Emax2}, {'NE2', NE2}, {'Gamma2', Gamma2}, {'DenseBorder', DenseBorder}})
        Grh_ = G + CreateResonantSpectra(H_m, H_f, Tr_2p_3d, Th_3d_2p, Psis_i, {{'Emin1', Emin1}, {'Emax1', Emax1}, {'NE1', NE1}, {'Gamma1', Gamma1}, {'Emin2', Emin2}, {'Emax2', Emax2}, {'NE2', NE2}, {'Gamma2', Gamma2}, {'DenseBorder', DenseBorder}})
        Glv_ = G + CreateResonantSpectra(H_m, H_f, Tl_2p_3d, Tv_3d_2p, Psis_i, {{'Emin1', Emin1}, {'Emax1', Emax1}, {'NE1', NE1}, {'Gamma1', Gamma1}, {'Emin2', Emin2}, {'Emax2', Emax2}, {'NE2', NE2}, {'Gamma2', Gamma2}, {'DenseBorder', DenseBorder}})
        Glh_ = G + CreateResonantSpectra(H_m, H_f, Tl_2p_3d, Th_3d_2p, Psis_i, {{'Emin1', Emin1}, {'Emax1', Emax1}, {'NE1', NE1}, {'Gamma1', Gamma1}, {'Emin2', Emin2}, {'Emax2', Emax2}, {'NE2', NE2}, {'Gamma2', Gamma2}, {'DenseBorder', DenseBorder}})
        Grr_ = G + CreateResonantSpectra(H_m, H_f, Tr_2p_3d, Tr_3d_2p, Psis_i, {{'Emin1', Emin1}, {'Emax1', Emax1}, {'NE1', NE1}, {'Gamma1', Gamma1}, {'Emin2', Emin2}, {'Emax2', Emax2}, {'NE2', NE2}, {'Gamma2', Gamma2}, {'DenseBorder', DenseBorder}})
        Grl_ = G + CreateResonantSpectra(H_m, H_f, Tr_2p_3d, Tl_3d_2p, Psis_i, {{'Emin1', Emin1}, {'Emax1', Emax1}, {'NE1', NE1}, {'Gamma1', Gamma1}, {'Emin2', Emin2}, {'Emax2', Emax2}, {'NE2', NE2}, {'Gamma2', Gamma2}, {'DenseBorder', DenseBorder}})
        Glr_ = G + CreateResonantSpectra(H_m, H_f, Tl_2p_3d, Tr_3d_2p, Psis_i, {{'Emin1', Emin1}, {'Emax1', Emax1}, {'NE1', NE1}, {'Gamma1', Gamma1}, {'Emin2', Emin2}, {'Emax2', Emax2}, {'NE2', NE2}, {'Gamma2', Gamma2}, {'DenseBorder', DenseBorder}})
        Gll_ = G + CreateResonantSpectra(H_m, H_f, Tl_2p_3d, Tl_3d_2p, Psis_i, {{'Emin1', Emin1}, {'Emax1', Emax1}, {'NE1', NE1}, {'Gamma1', Gamma1}, {'Emin2', Emin2}, {'Emax2', Emax2}, {'NE2', NE2}, {'Gamma2', Gamma2}, {'DenseBorder', DenseBorder}})
    else
        Grv_ = G + CreateResonantSpectra(H_m, H_f, Tr_2p_3d, Tv_3d_2p, Psis_i, {{'Emin1', Emin1}, {'Emax1', Emax1}, {'NE1', NE1}, {'Gamma1', Gamma1}, {'Emin2', Emin2}, {'Emax2', Emax2}, {'NE2', NE2}, {'Gamma2', Gamma2}, {'restrictions1', CalculationRestrictions}, {'restrictions2', CalculationRestrictions}, {'DenseBorder', DenseBorder}})
        Grh_ = G + CreateResonantSpectra(H_m, H_f, Tr_2p_3d, Th_3d_2p, Psis_i, {{'Emin1', Emin1}, {'Emax1', Emax1}, {'NE1', NE1}, {'Gamma1', Gamma1}, {'Emin2', Emin2}, {'Emax2', Emax2}, {'NE2', NE2}, {'Gamma2', Gamma2}, {'restrictions1', CalculationRestrictions}, {'restrictions2', CalculationRestrictions}, {'DenseBorder', DenseBorder}})
        Glv_ = G + CreateResonantSpectra(H_m, H_f, Tl_2p_3d, Tv_3d_2p, Psis_i, {{'Emin1', Emin1}, {'Emax1', Emax1}, {'NE1', NE1}, {'Gamma1', Gamma1}, {'Emin2', Emin2}, {'Emax2', Emax2}, {'NE2', NE2}, {'Gamma2', Gamma2}, {'restrictions1', CalculationRestrictions}, {'restrictions2', CalculationRestrictions}, {'DenseBorder', DenseBorder}})
        Glh_ = G + CreateResonantSpectra(H_m, H_f, Tl_2p_3d, Th_3d_2p, Psis_i, {{'Emin1', Emin1}, {'Emax1', Emax1}, {'NE1', NE1}, {'Gamma1', Gamma1}, {'Emin2', Emin2}, {'Emax2', Emax2}, {'NE2', NE2}, {'Gamma2', Gamma2}, {'restrictions1', CalculationRestrictions}, {'restrictions2', CalculationRestrictions}, {'DenseBorder', DenseBorder}})
        Grr_ = G + CreateResonantSpectra(H_m, H_f, Tr_2p_3d, Tr_3d_2p, Psis_i, {{'Emin1', Emin1}, {'Emax1', Emax1}, {'NE1', NE1}, {'Gamma1', Gamma1}, {'Emin2', Emin2}, {'Emax2', Emax2}, {'NE2', NE2}, {'Gamma2', Gamma2}, {'restrictions1', CalculationRestrictions}, {'restrictions2', CalculationRestrictions}, {'DenseBorder', DenseBorder}})
        Grl_ = G + CreateResonantSpectra(H_m, H_f, Tr_2p_3d, Tl_3d_2p, Psis_i, {{'Emin1', Emin1}, {'Emax1', Emax1}, {'NE1', NE1}, {'Gamma1', Gamma1}, {'Emin2', Emin2}, {'Emax2', Emax2}, {'NE2', NE2}, {'Gamma2', Gamma2}, {'restrictions1', CalculationRestrictions}, {'restrictions2', CalculationRestrictions}, {'DenseBorder', DenseBorder}})
        Glr_ = G + CreateResonantSpectra(H_m, H_f, Tl_2p_3d, Tr_3d_2p, Psis_i, {{'Emin1', Emin1}, {'Emax1', Emax1}, {'NE1', NE1}, {'Gamma1', Gamma1}, {'Emin2', Emin2}, {'Emax2', Emax2}, {'NE2', NE2}, {'Gamma2', Gamma2}, {'restrictions1', CalculationRestrictions}, {'restrictions2', CalculationRestrictions}, {'DenseBorder', DenseBorder}})
        Gll_ = G + CreateResonantSpectra(H_m, H_f, Tl_2p_3d, Tl_3d_2p, Psis_i, {{'Emin1', Emin1}, {'Emax1', Emax1}, {'NE1', NE1}, {'Gamma1', Gamma1}, {'Emin2', Emin2}, {'Emax2', Emax2}, {'NE2', NE2}, {'Gamma2', Gamma2}, {'restrictions1', CalculationRestrictions}, {'restrictions2', CalculationRestrictions}, {'DenseBorder', DenseBorder}})
    end
...
if ValueInTable(spectrum, spectra) then
    if CalculationRestrictions == nil then
        Gvv_ = G + CreateResonantSpectra(H_m, H_f, Tv_2p_3d, Tv_3d_2p, Psis_i, {{'Emin1', Emin1}, {'Emax1', Emax1}, {'NE1', NE1}, {'Gamma1', Gamma1}, {'Emin2', Emin2}, {'Emax2', Emax2}, {'NE2', NE2}, {'Gamma2', Gamma2}, {'DenseBorder', DenseBorder}})
        Gvh_ = G + CreateResonantSpectra(H_m, H_f, Tv_2p_3d, Th_3d_2p, Psis_i, {{'Emin1', Emin1}, {'Emax1', Emax1}, {'NE1', NE1}, {'Gamma1', Gamma1}, {'Emin2', Emin2}, {'Emax2', Emax2}, {'NE2', NE2}, {'Gamma2', Gamma2}, {'DenseBorder', DenseBorder}})
        Ghv_ = G + CreateResonantSpectra(H_m, H_f, Th_2p_3d, Tv_3d_2p, Psis_i, {{'Emin1', Emin1}, {'Emax1', Emax1}, {'NE1', NE1}, {'Gamma1', Gamma1}, {'Emin2', Emin2}, {'Emax2', Emax2}, {'NE2', NE2}, {'Gamma2', Gamma2}, {'DenseBorder', DenseBorder}})
        Ghh_ = G + CreateResonantSpectra(H_m, H_f, Th_2p_3d, Th_3d_2p, Psis_i, {{'Emin1', Emin1}, {'Emax1', Emax1}, {'NE1', NE1}, {'Gamma1', Gamma1}, {'Emin2', Emin2}, {'Emax2', Emax2}, {'NE2', NE2}, {'Gamma2', Gamma2}, {'DenseBorder', DenseBorder}})
    else
        Gvv_ = G + CreateResonantSpectra(H_m, H_f, Tv_2p_3d, Tv_3d_2p, Psis_i, {{'Emin1', Emin1}, {'Emax1', Emax1}, {'NE1', NE1}, {'Gamma1', Gamma1}, {'Emin2', Emin2}, {'Emax2', Emax2}, {'NE2', NE2}, {'Gamma2', Gamma2}, {'restrictions1', CalculationRestrictions}, {'restrictions2', CalculationRestrictions}, {'DenseBorder', DenseBorder}})
        Gvh_ = G + CreateResonantSpectra(H_m, H_f, Tv_2p_3d, Th_3d_2p, Psis_i, {{'Emin1', Emin1}, {'Emax1', Emax1}, {'NE1', NE1}, {'Gamma1', Gamma1}, {'Emin2', Emin2}, {'Emax2', Emax2}, {'NE2', NE2}, {'Gamma2', Gamma2}, {'restrictions1', CalculationRestrictions}, {'restrictions2', CalculationRestrictions}, {'DenseBorder', DenseBorder}})
        Ghv_ = G + CreateResonantSpectra(H_m, H_f, Th_2p_3d, Tv_3d_2p, Psis_i, {{'Emin1', Emin1}, {'Emax1', Emax1}, {'NE1', NE1}, {'Gamma1', Gamma1}, {'Emin2', Emin2}, {'Emax2', Emax2}, {'NE2', NE2}, {'Gamma2', Gamma2}, {'restrictions1', CalculationRestrictions}, {'restrictions2', CalculationRestrictions}, {'DenseBorder', DenseBorder}})
        Ghh_ = G + CreateResonantSpectra(H_m, H_f, Th_2p_3d, Th_3d_2p, Psis_i, {{'Emin1', Emin1}, {'Emax1', Emax1}, {'NE1', NE1}, {'Gamma1', Gamma1}, {'Emin2', Emin2}, {'Emax2', Emax2}, {'NE2', NE2}, {'Gamma2', Gamma2}, {'restrictions1', CalculationRestrictions}, {'restrictions2', CalculationRestrictions}, {'DenseBorder', DenseBorder}})
    end
