...
if H_atomic == 1 then
    ...
    F2_3d_4f_m = $F2(3d,4f)_m_value * $F2(3d,4f)_m_scale
    F4_3d_4f_m = $F4(3d,4f)_m_value * $F4(3d,4f)_m_scale
    G1_3d_4f_m = $G1(3d,4f)_m_value * $G1(3d,4f)_m_scale
    G3_3d_4f_m = $G3(3d,4f)_m_value * $G3(3d,4f)_m_scale
    G5_3d_4f_m = $G5(3d,4f)_m_value * $G5(3d,4f)_m_scale
...
if H_4f_ligands_hybridization_lmct == 1 then
    ...
    e_4f_m = (28 * Delta_4f_L1_m - 460 * U_3d_4f_m - U_4f_4f_m * NElectrons_4f^2 - 47 * U_4f_4f_m * NElectrons_4f) / (2 * (NElectrons_4f + 24))
    e_3d_m = (28 * Delta_4f_L1_m - 2 * U_3d_4f_m * NElectrons_4f^2 - 30 * U_3d_4f_m * NElectrons_4f - 28 * U_3d_4f_m + U_4f_4f_m * NElectrons_4f^2 + U_4f_4f_m * NElectrons_4f) / (2 * (NElectrons_4f + 24))
    e_L1_m = (-2 * Delta_4f_L1_m * NElectrons_4f - 20 * Delta_4f_L1_m + 20 * U_3d_4f_m * NElectrons_4f + 20 * U_3d_4f_m + U_4f_4f_m * NElectrons_4f^2 + U_4f_4f_m * NElectrons_4f) / (2 * (NElectrons_4f + 24))
...
function CalculateT_3d_4f(e)
    -- Calculate the transition operator for arbitrary polarization.
    T = e[1] * Tx_3d_4f + e[2] * Ty_3d_4f + e[3] * Tz_3d_4f
    return Chop(T)
end

function CalculateT_4f_3d(e)
    -- Calculate the transition operator for arbitrary polarization.
    T = e[1] * Tx_4f_3d + e[2] * Ty_4f_3d + e[3] * Tz_4f_3d
    return Chop(T)
end

Tv_3d_4f = CalculateT_3d_4f(ev1)
Th_3d_4f = CalculateT_3d_4f(eh1)
Tr_3d_4f = CalculateT_3d_4f(er1)
Tl_3d_4f = CalculateT_3d_4f(el1)
Tk_3d_4f = CalculateT_3d_4f(k1)

Tv_4f_3d = CalculateT_4f_3d(ev2)
Th_4f_3d = CalculateT_4f_3d(eh2)
Tr_4f_3d = CalculateT_4f_3d(er2)
Tl_4f_3d = CalculateT_4f_3d(el2)
Tk_4f_3d = CalculateT_4f_3d(k2)
...
-------------------------------------------------------------------------------
-- Analyze the final Hamiltonian (H_f)
-------------------------------------------------------------------------------
-- if CalculationRestrictions == nil then
--     Psis_f = Eigensystem(H_f, FinalRestrictions, 500) -- or however many you want
-- else
--     Psis_f = Eigensystem(H_f, FinalRestrictions, 500, {{'restrictions', CalculationRestrictions}})
-- end

-- io.write('\nAnalysis of the final Hamiltonian (H_f):\n')
-- io.write('====================================================================================================================\n')
-- io.write('State         <E>     <S^2>     <L^2>     <J^2>      <l.s>     <N_3d>\n')
-- io.write('====================================================================================================================\n')

-- io.write('Here starts final states:')
-- for i, Psi in ipairs(Psis_f) do
--     local E = Psi * H_f * Psi
--     local S2 = Psi * Ssqr * Psi
--     local L2 = Psi * Lsqr * Psi
--     local J2 = Psi * Jsqr * Psi
--     local ls = Psi * ldots_3d * Psi
--     local N3d = Psi * N_3d * Psi
--     io.write(string.format('%5d  %9.6f  %9.4f  %9.4f  %9.4f  %9.4f  %9.4f\n', i, E, S2, L2, J2, ls, N3d))
-- end
-- io.write('Here ends final states')
...
if ValueInTable(spectrum, spectra) then
    if CalculationRestrictions == nil then
        G = G + CreateResonantSpectra(H_m, H_f, {Tx_3d_4f, Ty_3d_4f, Tz_3d_4f}, {Tx_4f_3d, Ty_4f_3d, Tz_4f_3d}, Psis_i, {{'Emin1', Emin1}, {'Emax1', Emax1}, {'NE1', NE1}, {'Gamma1', Gamma1}, {'Emin2', Emin2}, {'Emax2', Emax2}, {'NE2', NE2}, {'Gamma2', Gamma2}, {'DenseBorder', DenseBorder}})
    else
        G = G + CreateResonantSpectra(H_m, H_f, {Tx_3d_4f, Ty_3d_4f, Tz_3d_4f}, {Tx_4f_3d, Ty_4f_3d, Tz_4f_3d}, Psis_i, {{'Emin1', Emin1}, {'Emax1', Emax1}, {'NE1', NE1}, {'Gamma1', Gamma1}, {'Emin2', Emin2}, {'Emax2', Emax2}, {'NE2', NE2}, {'Gamma2', Gamma2}, {'restrictions1', CalculationRestrictions}, {'restrictions2', CalculationRestrictions}, {'DenseBorder', DenseBorder}})
    end
...
if ValueInTable(spectrum, spectra) then
    if CalculationRestrictions == nil then
        Grv_ = G + CreateResonantSpectra(H_m, H_f, Tr_3d_4f, Tv_4f_3d, Psis_i, {{'Emin1', Emin1}, {'Emax1', Emax1}, {'NE1', NE1}, {'Gamma1', Gamma1}, {'Emin2', Emin2}, {'Emax2', Emax2}, {'NE2', NE2}, {'Gamma2', Gamma2}, {'DenseBorder', DenseBorder}})
        Grh_ = G + CreateResonantSpectra(H_m, H_f, Tr_3d_4f, Th_4f_3d, Psis_i, {{'Emin1', Emin1}, {'Emax1', Emax1}, {'NE1', NE1}, {'Gamma1', Gamma1}, {'Emin2', Emin2}, {'Emax2', Emax2}, {'NE2', NE2}, {'Gamma2', Gamma2}, {'DenseBorder', DenseBorder}})
        Glv_ = G + CreateResonantSpectra(H_m, H_f, Tl_3d_4f, Tv_4f_3d, Psis_i, {{'Emin1', Emin1}, {'Emax1', Emax1}, {'NE1', NE1}, {'Gamma1', Gamma1}, {'Emin2', Emin2}, {'Emax2', Emax2}, {'NE2', NE2}, {'Gamma2', Gamma2}, {'DenseBorder', DenseBorder}})
        Glh_ = G + CreateResonantSpectra(H_m, H_f, Tl_3d_4f, Th_4f_3d, Psis_i, {{'Emin1', Emin1}, {'Emax1', Emax1}, {'NE1', NE1}, {'Gamma1', Gamma1}, {'Emin2', Emin2}, {'Emax2', Emax2}, {'NE2', NE2}, {'Gamma2', Gamma2}, {'DenseBorder', DenseBorder}})
        Grr_ = G + CreateResonantSpectra(H_m, H_f, Tr_3d_4f, Tr_4f_3d, Psis_i, {{'Emin1', Emin1}, {'Emax1', Emax1}, {'NE1', NE1}, {'Gamma1', Gamma1}, {'Emin2', Emin2}, {'Emax2', Emax2}, {'NE2', NE2}, {'Gamma2', Gamma2}, {'DenseBorder', DenseBorder}})
        Grl_ = G + CreateResonantSpectra(H_m, H_f, Tr_3d_4f, Tl_4f_3d, Psis_i, {{'Emin1', Emin1}, {'Emax1', Emax1}, {'NE1', NE1}, {'Gamma1', Gamma1}, {'Emin2', Emin2}, {'Emax2', Emax2}, {'NE2', NE2}, {'Gamma2', Gamma2}, {'DenseBorder', DenseBorder}})
        Glr_ = G + CreateResonantSpectra(H_m, H_f, Tl_3d_4f, Tr_4f_3d, Psis_i, {{'Emin1', Emin1}, {'Emax1', Emax1}, {'NE1', NE1}, {'Gamma1', Gamma1}, {'Emin2', Emin2}, {'Emax2', Emax2}, {'NE2', NE2}, {'Gamma2', Gamma2}, {'DenseBorder', DenseBorder}})
        Gll_ = G + CreateResonantSpectra(H_m, H_f, Tl_3d_4f, Tl_4f_3d, Psis_i, {{'Emin1', Emin1}, {'Emax1', Emax1}, {'NE1', NE1}, {'Gamma1', Gamma1}, {'Emin2', Emin2}, {'Emax2', Emax2}, {'NE2', NE2}, {'Gamma2', Gamma2}, {'DenseBorder', DenseBorder}})
    else
        Grv_ = G + CreateResonantSpectra(H_m, H_f, Tr_3d_4f, Tv_4f_3d, Psis_i, {{'Emin1', Emin1}, {'Emax1', Emax1}, {'NE1', NE1}, {'Gamma1', Gamma1}, {'Emin2', Emin2}, {'Emax2', Emax2}, {'NE2', NE2}, {'Gamma2', Gamma2}, {'restrictions1', CalculationRestrictions}, {'restrictions2', CalculationRestrictions}, {'DenseBorder', DenseBorder}})
        Grh_ = G + CreateResonantSpectra(H_m, H_f, Tr_3d_4f, Th_4f_3d, Psis_i, {{'Emin1', Emin1}, {'Emax1', Emax1}, {'NE1', NE1}, {'Gamma1', Gamma1}, {'Emin2', Emin2}, {'Emax2', Emax2}, {'NE2', NE2}, {'Gamma2', Gamma2}, {'restrictions1', CalculationRestrictions}, {'restrictions2', CalculationRestrictions}, {'DenseBorder', DenseBorder}})
        Glv_ = G + CreateResonantSpectra(H_m, H_f, Tl_3d_4f, Tv_4f_3d, Psis_i, {{'Emin1', Emin1}, {'Emax1', Emax1}, {'NE1', NE1}, {'Gamma1', Gamma1}, {'Emin2', Emin2}, {'Emax2', Emax2}, {'NE2', NE2}, {'Gamma2', Gamma2}, {'restrictions1', CalculationRestrictions}, {'restrictions2', CalculationRestrictions}, {'DenseBorder', DenseBorder}})
        Glh_ = G + CreateResonantSpectra(H_m, H_f, Tl_3d_4f, Th_4f_3d, Psis_i, {{'Emin1', Emin1}, {'Emax1', Emax1}, {'NE1', NE1}, {'Gamma1', Gamma1}, {'Emin2', Emin2}, {'Emax2', Emax2}, {'NE2', NE2}, {'Gamma2', Gamma2}, {'restrictions1', CalculationRestrictions}, {'restrictions2', CalculationRestrictions}, {'DenseBorder', DenseBorder}})
        Grr_ = G + CreateResonantSpectra(H_m, H_f, Tr_3d_4f, Tr_4f_3d, Psis_i, {{'Emin1', Emin1}, {'Emax1', Emax1}, {'NE1', NE1}, {'Gamma1', Gamma1}, {'Emin2', Emin2}, {'Emax2', Emax2}, {'NE2', NE2}, {'Gamma2', Gamma2}, {'restrictions1', CalculationRestrictions}, {'restrictions2', CalculationRestrictions}, {'DenseBorder', DenseBorder}})
        Grl_ = G + CreateResonantSpectra(H_m, H_f, Tr_3d_4f, Tl_4f_3d, Psis_i, {{'Emin1', Emin1}, {'Emax1', Emax1}, {'NE1', NE1}, {'Gamma1', Gamma1}, {'Emin2', Emin2}, {'Emax2', Emax2}, {'NE2', NE2}, {'Gamma2', Gamma2}, {'restrictions1', CalculationRestrictions}, {'restrictions2', CalculationRestrictions}, {'DenseBorder', DenseBorder}})
        Glr_ = G + CreateResonantSpectra(H_m, H_f, Tl_3d_4f, Tr_4f_3d, Psis_i, {{'Emin1', Emin1}, {'Emax1', Emax1}, {'NE1', NE1}, {'Gamma1', Gamma1}, {'Emin2', Emin2}, {'Emax2', Emax2}, {'NE2', NE2}, {'Gamma2', Gamma2}, {'restrictions1', CalculationRestrictions}, {'restrictions2', CalculationRestrictions}, {'DenseBorder', DenseBorder}})
        Gll_ = G + CreateResonantSpectra(H_m, H_f, Tl_3d_4f, Tl_4f_3d, Psis_i, {{'Emin1', Emin1}, {'Emax1', Emax1}, {'NE1', NE1}, {'Gamma1', Gamma1}, {'Emin2', Emin2}, {'Emax2', Emax2}, {'NE2', NE2}, {'Gamma2', Gamma2}, {'restrictions1', CalculationRestrictions}, {'restrictions2', CalculationRestrictions}, {'DenseBorder', DenseBorder}})
    end
...
if ValueInTable(spectrum, spectra) then
    if CalculationRestrictions == nil then
        Gvv_ = G + CreateResonantSpectra(H_m, H_f, Tv_3d_4f, Tv_4f_3d, Psis_i, {{'Emin1', Emin1}, {'Emax1', Emax1}, {'NE1', NE1}, {'Gamma1', Gamma1}, {'Emin2', Emin2}, {'Emax2', Emax2}, {'NE2', NE2}, {'Gamma2', Gamma2}, {'DenseBorder', DenseBorder}})
        Gvh_ = G + CreateResonantSpectra(H_m, H_f, Tv_3d_4f, Th_4f_3d, Psis_i, {{'Emin1', Emin1}, {'Emax1', Emax1}, {'NE1', NE1}, {'Gamma1', Gamma1}, {'Emin2', Emin2}, {'Emax2', Emax2}, {'NE2', NE2}, {'Gamma2', Gamma2}, {'DenseBorder', DenseBorder}})
        Ghv_ = G + CreateResonantSpectra(H_m, H_f, Th_3d_4f, Tv_4f_3d, Psis_i, {{'Emin1', Emin1}, {'Emax1', Emax1}, {'NE1', NE1}, {'Gamma1', Gamma1}, {'Emin2', Emin2}, {'Emax2', Emax2}, {'NE2', NE2}, {'Gamma2', Gamma2}, {'DenseBorder', DenseBorder}})
        Ghh_ = G + CreateResonantSpectra(H_m, H_f, Th_3d_4f, Th_4f_3d, Psis_i, {{'Emin1', Emin1}, {'Emax1', Emax1}, {'NE1', NE1}, {'Gamma1', Gamma1}, {'Emin2', Emin2}, {'Emax2', Emax2}, {'NE2', NE2}, {'Gamma2', Gamma2}, {'DenseBorder', DenseBorder}})
    else
        Gvv_ = G + CreateResonantSpectra(H_m, H_f, Tv_3d_4f, Tv_4f_3d, Psis_i, {{'Emin1', Emin1}, {'Emax1', Emax1}, {'NE1', NE1}, {'Gamma1', Gamma1}, {'Emin2', Emin2}, {'Emax2', Emax2}, {'NE2', NE2}, {'Gamma2', Gamma2}, {'restrictions1', CalculationRestrictions}, {'restrictions2', CalculationRestrictions}, {'DenseBorder', DenseBorder}})
        Gvh_ = G + CreateResonantSpectra(H_m, H_f, Tv_3d_4f, Th_4f_3d, Psis_i, {{'Emin1', Emin1}, {'Emax1', Emax1}, {'NE1', NE1}, {'Gamma1', Gamma1}, {'Emin2', Emin2}, {'Emax2', Emax2}, {'NE2', NE2}, {'Gamma2', Gamma2}, {'restrictions1', CalculationRestrictions}, {'restrictions2', CalculationRestrictions}, {'DenseBorder', DenseBorder}})
        Ghv_ = G + CreateResonantSpectra(H_m, H_f, Th_3d_4f, Tv_4f_3d, Psis_i, {{'Emin1', Emin1}, {'Emax1', Emax1}, {'NE1', NE1}, {'Gamma1', Gamma1}, {'Emin2', Emin2}, {'Emax2', Emax2}, {'NE2', NE2}, {'Gamma2', Gamma2}, {'restrictions1', CalculationRestrictions}, {'restrictions2', CalculationRestrictions}, {'DenseBorder', DenseBorder}})
        Ghh_ = G + CreateResonantSpectra(H_m, H_f, Th_3d_4f, Th_4f_3d, Psis_i, {{'Emin1', Emin1}, {'Emax1', Emax1}, {'NE1', NE1}, {'Gamma1', Gamma1}, {'Emin2', Emin2}, {'Emax2', Emax2}, {'NE2', NE2}, {'Gamma2', Gamma2}, {'restrictions1', CalculationRestrictions}, {'restrictions2', CalculationRestrictions}, {'DenseBorder', DenseBorder}})
    end
