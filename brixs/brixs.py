...
class Spectra(metaclass=_Meta):
    ...
    **Computed (read-only) attributes:**
    ...
    def shift_plot(self, xlim=None, ylim=None, step=None, vlines=None, update_function=None):
        ...
        if update_function is None:
            def _update(ss):
                ...
                ss[self.__i].plot(shift=self._calculated_shift[self.__i], color='black', marker='o')
    ...
    def roll_plot(self, xlim=None, ylim=None, vlines=None, update_function=None):
...
class Image(metaclass=_Meta):
    ...
    def imshow(self, ax=None, colorbar=False, verbose=True, **kwargs):
        ...
        pos.x_edges = np.linspace(pos._extent[0], pos._extent[1], len(self.x_centers)+1)
        pos.y_edges = np.linspace(pos._extent[2], pos._extent[3], len(self.y_centers)+1)
