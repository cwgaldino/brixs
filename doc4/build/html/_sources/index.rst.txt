...
The goal of having only four major classes, is to make to code easy to maintain. 
Despite of that, BRIXS also have a few minor classes
...
.. code=block::
   ...
   br.ADRESS.read(folderpath, 'Cu_', 56)
